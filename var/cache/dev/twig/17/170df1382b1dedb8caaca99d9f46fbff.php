...
/* about.html.twig */
class __TwigTemplate_592d708df94d393dd50153703c995792 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "    ";
        // line 11
        echo "    <div class=\"grid-container two-col golden-ratio\">
        <div class=\"col-2\">
            ";
        // line 13
        echo (isset($context["text"]) || array_key_exists("text", $context) ? $context["text"] : (function () { throw new RuntimeError('Variable "text" does not exist.', 13, $this->source); })());
        echo "
        </div>
        <div class=\"col-1 mvc-image\" style=\"background-image: url(";
        // line 15
...
";
    ...
    {
        return array (  99 => 15,  94 => 13,  90 => 11,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"grid-container two-col golden-ratio\">
        <div class=\"col-2\">
            {{ text | raw }}
        </div>
        <div class=\"col-1 mvc-image\" style=\"background-image: url({{ asset('img/about.jpg') }})\">
        </div>
    </div>
{% endblock %}", "about.html.twig", "/home/juli22/dbwebb-kurser/mvc/me/report/templates/about.html.twig");
    }
}
