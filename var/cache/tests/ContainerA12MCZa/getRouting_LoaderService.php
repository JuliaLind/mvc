 ...
 */
class getRouting_LoaderService extends App_KernelTestsDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\Routing\AnnotatedRouteControllerLoader(($container->privates['annotations.cached_reader'] ?? $container->getAnnotations_CachedReaderService()), 'tests');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($b, 'tests'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($b, 'tests'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($b, 'tests'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($b, 'tests'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($b, 'tests'));
