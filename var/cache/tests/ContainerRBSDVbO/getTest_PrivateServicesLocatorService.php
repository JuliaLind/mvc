 ...
 */
class getTest_PrivateServicesLocatorService extends App_KernelTestsDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Cards\\CardDeckHandler' => ['privates', 'App\\Cards\\CardDeckHandler', 'getCardDeckHandlerService', true],
            'App\\Cards\\CardHand' => ['privates', 'App\\Cards\\CardHand', 'getCardHandService', true],
            'App\\Cards\\CardHandler' => ['privates', 'App\\Cards\\CardHandler', 'getCardHandlerService', true],
            'App\\Cards\\CardLandingHandler' => ['privates', 'App\\Cards\\CardLandingHandler', 'getCardLandingHandlerService', true],
            'App\\Cards\\DeckOfCards' => ['privates', 'App\\Cards\\DeckOfCards', 'getDeckOfCardsService', true],
            'App\\Cards\\JsonCardHandler' => ['privates', 'App\\Cards\\JsonCardHandler', 'getJsonCardHandlerService', true],
            'App\\Cards\\Player' => ['privates', 'App\\Cards\\Player', 'getPlayerService', true],
            'App\\Cards\\PlayerCreator' => ['privates', 'App\\Cards\\PlayerCreator', 'getPlayerCreatorService', true],
            'App\\Game\\BanksTurnHandler' => ['privates', 'App\\Game\\BanksTurnHandler', 'getBanksTurnHandlerService', true],
            'App\\Game\\GameHandler' => ['privates', 'App\\Game\\GameHandler', 'getGameHandlerService', true],
            'App\\Game\\GameHandlerLanding' => ['privates', 'App\\Game\\GameHandlerLanding', 'getGameHandlerLandingService', true],
            'App\\Game\\GameInitiator' => ['privates', 'App\\Game\\GameInitiator', 'getGameInitiatorService', true],
            'App\\Game\\GameMoneyHandler' => ['privates', 'App\\Game\\GameMoneyHandler', 'getGameMoneyHandlerService', true],
            'App\\Game\\JsonGameHandler' => ['privates', 'App\\Game\\JsonGameHandler', 'getJsonGameHandlerService', true],
            'App\\Game\\PlayerTurnHandler' => ['privates', 'App\\Game\\PlayerTurnHandler', 'getPlayerTurnHandlerService', true],
            'App\\Game\\RoundHandler' => ['privates', 'App\\Game\\RoundHandler', 'getRoundHandlerService', true],
            'App\\Helpers\\JsonConverter' => ['privates', 'App\\Helpers\\JsonConverter', 'getJsonConverterService', true],
            'App\\Helpers\\JsonHandler' => ['privates', 'App\\Helpers\\JsonHandler', 'getJsonHandlerService', true],
            'App\\Helpers\\LuckyRouteData' => ['privates', 'App\\Helpers\\LuckyRouteData', 'getLuckyRouteDataService', true],
            'App\\Helpers\\MainControllerHelper' => ['privates', 'App\\Helpers\\MainControllerHelper', 'getMainControllerHelperService', true],
            'App\\Library\\BookRemover' => ['privates', 'App\\Library\\BookRemover', 'getBookRemoverService', true],
            'App\\Library\\BookSaver' => ['privates', 'App\\Library\\BookSaver', 'getBookSaverService', true],
            'App\\Library\\BookUpdator' => ['privates', 'App\\Library\\BookUpdator', 'getBookUpdatorService', true],
            'App\\Library\\LibraryHandler' => ['privates', 'App\\Library\\LibraryHandler', 'getLibraryHandlerService', true],
            ...
            'assets._version__default' => ['privates', 'assets._version__default', 'getAssets_VersionDefaultService', true],
            ...
            'notifier.logger_notification_listener' => ['privates', 'notifier.logger_notification_listener', 'getNotifier_LoggerNotificationListenerService', true],
            ...
            'twig.extension.markdown' => ['privates', 'twig.extension.markdown', 'getTwig_Extension_MarkdownService', true],
            'twig.runtime.markdown' => ['privates', 'twig.runtime.markdown', 'getTwig_Runtime_MarkdownService', true],
            'twig.markdown.default' => ['privates', 'twig.markdown.default', 'getTwig_Markdown_DefaultService', true],
            ...
            'webpack_encore.twig_entry_files_extension' => ['privates', 'webpack_encore.twig_entry_files_extension', 'getWebpackEncore_TwigEntryFilesExtensionService', true],
            'webpack_encore.twig_stimulus_extension' => ['privates', 'webpack_encore.twig_stimulus_extension', 'getWebpackEncore_TwigStimulusExtensionService', true],
            ...
            'argument_resolver.controller_locator' => ['privates', '.service_locator.Xr0fs2y', 'get_ServiceLocator_Xr0fs2yService', true],
