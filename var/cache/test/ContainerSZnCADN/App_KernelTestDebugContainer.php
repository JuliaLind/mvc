...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\CardLandingController' => 'getCardLandingControllerService',
            'App\\Controller\\Game21Controller' => 'getGame21ControllerService',
            'App\\Controller\\JsonCardDealController' => 'getJsonCardDealControllerService',
            'App\\Controller\\JsonCardDeckController' => 'getJsonCardDeckControllerService',
            'App\\Controller\\JsonController' => 'getJsonControllerService',
            'App\\Controller\\JsonDealManyCardsController' => 'getJsonDealManyCardsControllerService',
            'App\\Controller\\JsonDealOneCardController' => 'getJsonDealOneCardControllerService',
            'App\\Controller\\JsonGame21Controller' => 'getJsonGame21ControllerService',
            'App\\Controller\\JsonLibraryController' => 'getJsonLibraryControllerService',
            'App\\Controller\\LibraryController' => 'getLibraryControllerService',
            'App\\Controller\\LibraryUpdateBookController' => 'getLibraryUpdateBookControllerService',
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sMZxbFAFmC', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('+--Qsn4-3h', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
    ...
    {
        return $this->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BNzZFauFqE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mdEI6FBMeF', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kZnRWu1tZd', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Tfm9s6yRAE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YSACZKYCrG', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cLu2u31OKz', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.webpack_encore.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('42Yjyip68d', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnection_ConfigurationService()
    {
        ...
        $instance->setMiddlewares([0 => ($this->privates['dama.doctrine.dbal.middleware'] ?? ($this->privates['dama.doctrine.dbal.middleware'] = new \DAMA\DoctrineTestBundle\Doctrine\DBAL\Middleware())), 1 => new \Doctrine\DBAL\Logging\Middleware(($this->privates['monolog.logger.doctrine'] ?? $this->getMonolog_Logger_DoctrineService())), 2 => $a]);
    ...
    protected function getDoctrine_Dbal_DefaultConnection_EventManagerService()
    {
        ...
        ]), [0 => [0 => [0 => 'postConnect'], 1 => 'dama.doctrine.dbal.post_connect_event_listener.default'], 1 => 'doctrine.orm.messenger.doctrine_schema_subscriber', 2 => 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber', 3 => 'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber', 4 => [0 => [0 => 'loadClassMetadata'], 1 => 'doctrine.orm.default_listeners.attach_entity_listeners']]);
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(($this->privates['twig.extension.markdown'] ?? ($this->privates['twig.extension.markdown'] = new \Twig\Extra\Markdown\MarkdownExtension())));
     ...
     */
    protected function getTwig_Extension_MarkdownService()
    {
        return $this->privates['twig.extension.markdown'] = new \Twig\Extra\Markdown\MarkdownExtension();
    }
