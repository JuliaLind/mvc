...
/* card/deck.html.twig */
class __TwigTemplate_9b691ebb9dacaa8203755ecf3fd12a0b extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["card"]) {
            ...
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl($context["card"]), "html", null, true);
            echo "\" alt=\"";
...
";
    ...
    {
        return array (  111 => 13,  100 => 11,  96 => 10,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% for card in cards %}
    <img class=\"card\" src=\"{{ asset(card) }}\" alt=\"{{ card }}\">
{% endfor %}

</div>

{% endblock %}", "card/deck.html.twig", "/home/juli22/dbwebb-kurser/mvc/me/report/templates/card/deck.html.twig");
    }
}
