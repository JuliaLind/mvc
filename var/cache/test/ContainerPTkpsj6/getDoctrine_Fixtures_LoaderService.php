...
class getDoctrine_Fixtures_LoaderService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/BookFixture.php';
        ...
        $instance->addFixtures([0 => ['fixture' => ($container->privates['App\\DataFixtures\\AppFixtures'] ?? ($container->privates['App\\DataFixtures\\AppFixtures'] = new \App\DataFixtures\AppFixtures())), 'groups' => []], 1 => ['fixture' => ($container->privates['App\\DataFixtures\\BookFixture'] ?? ($container->privates['App\\DataFixtures\\BookFixture'] = new \App\DataFixtures\BookFixture())), 'groups' => []]]);
