...
class EvaluateTraitTest extends KernelTestCase
{
    ...
    public function testEvaluatePlayerWon(): void
    {
        ...
        $this->assertEquals(
            "Game finished, You got 100 points and House got 999 points. House won",
            $this->message
        );
    ...
    public function testEvaluateHouseWon(): void
    {
        ...
        $this->assertEquals(
            "Game finished, You got 374 points and House got 10 points. You won and received 80 coins",
            $this->message
        );
        $this->assertEquals(0, $this->pot);
    }
