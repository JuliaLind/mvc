...
trait FullHouseTrait6
{
     ...
     * FullHouseTrait4
     *
     * @param int $three - 0 if three of the same rank has not been checked before
     ...
     */
    private function checkThree(int $three, int $countRank): bool
    {
        return $three === 0 && $countRank >= 3;
    }
}
