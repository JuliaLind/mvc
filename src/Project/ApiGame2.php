...
/**
 * Represents part of the logic of the Poker Squares game. Places a card into an empty grid accoring to passed arguemnts and returns data containing the grid, the remaining card and a message describing the card palcement for API route
 */
class ApiGame2
{
    /**
